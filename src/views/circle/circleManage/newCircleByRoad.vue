...
<script>
//  ========获取圈类型=======基于同路人创建圈======获取圈标签=========头像
import { getCircleType,creatCircleByRoad, getCircleLable,uploadcircle } from '@/api/circle/customCreatCircle'
export default {
  data() {
    return {
...
//  		this.$refs.iconUpload.submit()
				if(this.isUpload == false){
		    		...
		    		creatCircleByRoad(this.form).then(res => {
