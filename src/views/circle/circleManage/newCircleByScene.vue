<template>
  <div class="form" style="width: 60%;margin: 30px;">
    <el-form v-model="form" ref="form"  style="width:70%">
      ...
      <el-form-item prop="" label="坐标：">
      </el-form-item>
      <el-form-item prop="" label="地理位置：">
      </el-form-item>
...
<script>
//  ========获取圈类型=======基于场景创建圈======获取圈标签=========头像
import { getCircleType,creatCircleByScene, getCircleLable,uploadcircle } from '@/api/circle/customCreatCircle'
export default {
  data() {
    return {
...
//  		this.$refs.iconUpload.submit()
				if(this.isUpload == false){
		    		...
		    		creatCircleByScene(this.form).then(res => {
