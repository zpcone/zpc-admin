      ...
      <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
        <el-tab-pane label="通知类消息" name="1">
          <el-form :model="noteInform" :rules="rules" ref="noteInform" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="渠道" prop="list">
               ...
               <!-- <el-checkbox-group v-model="noteInform.list">
                <el-checkbox @change = "messChange" label="短信" name="短信"></el-checkbox>
                <el-checkbox @change = "anChange" label="IOS" name="IOS"></el-checkbox>
                <el-checkbox @change = "iosChange" label="安卓" name="安卓"></el-checkbox>
                <el-checkbox @change = "innerChange" label="站内信" name="站内信"></el-checkbox>
              </el-checkbox-group> -->
            </el-form-item>
            ...
            <el-form-item label="模板名称" prop="templateName">
              <el-input clearable v-model="noteInform.templateName" placeholder="请输入模板名称" style="width:300px;"></el-input>
            </el-form-item>
            <el-form-item v-if="messageGeted" label="短信签名" prop="messageSignatures">
              <el-input clearable v-model="noteInform.messageSignatures" placeholder="请输入" style="width:300px;"></el-input>
            </el-form-item>
            <el-form-item v-if="messageGeted" label="短信内容" prop="messageContext" style="width:400px;">
              <el-input clearable type="textarea" placeholder="请输入短信内容" v-model="noteInform.messageContext"></el-input>
            </el-form-item>
            ...
            <el-form-item v-if="!messageGeted" label="模板内容" prop="messageContext" style="width:400px;">
              <el-input clearable type="textarea" v-model="noteInform.messageContext"></el-input>
            </el-form-item>
            <el-form-item>
        ...
        <el-tab-pane label="营销消息" name="3">
          <el-form :model="marketingInform" :rules="rules" ref="marketingInform" label-width="100px" class="demo-ruleForm">
            ...
            <!-- <el-form-item prop="circleHead" label="通知图标:">
              <el-upload
                class="avatar-uploader"
                :show-file-list="false"
                name="filename"
...
<script>
  import { addTemplate, imgUpload} from '@/api/notice'
  ...
  // 短信通知form
        ...
        noteInform: {
          ...
          templateName: '', // 模板名称
          templateSystem: '1',  //应用系统分类(1电商2社交)
          messageContext: '',  /*短信内容*/
  ...
  // 营销 消息form
        ...
        rules: {
          templateSystem: [
            { required: true, message: '请选择系统消息', trigger: 'blur' }
          ],
          list: [
    ...
    methods:{
      ...
      noteInformSubmit(formName) {
        ...
        _this.$refs[formName].validate((valid) => {
          _this.noteInform.templateSystem = '1'
          if (valid) {
      ...
      codeInformSubmit(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            var arr = this.codeInform.list
            // this.circulation(arr)
     ...
     // 营销类消息进行验证的方法
      verification (formName) {
        ...
        _this.$refs[formName].validate((valid) => {
          if (valid) {
            _this.marketingInform.templateType = _this.activeName
            var arr = _this.marketingInform.list
            // this.circulation(arr)
            _this.send(_this.marketingInform)
          }else {
              _this.$message({
                message: '请输入完整内容!',
                type: 'error'
    ...
    // 营销类消息 ----保存
      marketingInformSubmit(formName) {
        var _this = this
        console.log(_this.marketingInform)
        this.noteInform.templateSystem = '2'
        var index = _this.marketingInform.list.indexOf('1')
        if (index < 0) {
          ...
          // {
            ...
            delete _this.marketingInform.messageSignatures
            delete _this.marketingInform.control
            _this.send(_this.marketingInform)
          // }
        } else if (index >= 0) {
          delete _this.marketingInform.templateTitele
          delete _this.marketingInform.templatePicture
          _this.send(_this.marketingInform)
        }
      },
      // 循环判断处理
      ...
      send (data) {
        ...
        .then(response => {
          ...
          this.$router.push('/noticeManageOneWrapper/myMaonoticeManage/index')
          this.$message({
            message: '成功保存模板!',
            type: 'success'
          })
