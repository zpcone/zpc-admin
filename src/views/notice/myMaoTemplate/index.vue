      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <!-- <el-button @click="editClick(scope.row)" type="text" size="small" v-if="false">编辑</el-button> -->
...
import { parseTime } from '@/utils'
  export default{
    ...
    methods: {
      ...
      creatNewTemplate() {
        console.log('新建模板!')
        this.$router.push('/noticeManageOneWrapper/myMaonoticeManage/new')
      },
      // 点击提交审核
      submitCheck (row) {
