<template>
  <div class="templateManage">
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
      ...
      <!-- <el-button v-if="isShowUpload" @click="getExcelTem" style="margin-left:15px;" type="info" plain>获取excel示例</el-button> -->
      </el-form-item>
...
// 消息发送 选择模板 获取excel模板
  ...
  // import { excelUrl, uploadExcelUrl } from '@/api/uploadExcel'
  export default{
    data(){
      return{
        timePicker: '',
          ...
          if (valid) {
            if (this.ruleForm.expirationTime) {
              if (this.ruleForm.targetUser == '2') {
                ...
                if (this.ruleForm.messageType == '2') {
                  this.saveSendMessage ()
                } else if (this.ruleForm.messageType == '1' && !this.ruleForm.pushTime) {
                  this.$message({
                    message: '请选择推送时间!',
                    type: 'error'
                  })
