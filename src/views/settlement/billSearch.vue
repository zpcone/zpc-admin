          ...
          <el-col :span="12">
            ...
            <el-form-item prop="paymentStatus" label="付款单状态：">
              <el-radio-group v-model="form.paymentStatus">
                ...
                <el-radio-button label="4">付款成功</el-radio-button>
                <el-radio-button label="5">付款失败</el-radio-button>
              </el-radio-group>
            </el-form-item>
...
<script>
import { searchPaymentList, searchPayeeList, searchAuditorList } from '@/api/settlement'
