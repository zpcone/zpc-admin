...
export const constantRouterMap = [
  ...
  },
  {
    ...
    component: Layout,
    name: 'settlement',
    redirect: '/settlement/back/order',
    ...
    children: [
      ...
      },
      {
        ...
        component: ThreeLayout,
        redirect: '/settlement/finance/bill',
        ...
        children: [
          ...
          },
          {
            ...
            component: _import('settlement/billDetail'),
            hidden: true,
            meta: { title: '结算详情' }
          },
          {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        hidden: true,
        meta: { title: '查询供应商及分配规则', icon: 'qudaoguanli' }
      },
      {
        path: 'ratio',
        name: 'sbumanageRatio',
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            hidden: true,
            name: 'newGroupMember',
            component: _import('group/groupManage/membersEdit'),
            meta: { title: '群成员编辑', icon: '' }
          },
          {
            path: 'member/new',
            hidden: true,
      ...
      },
      {
        path: 'bussiness',
        name: 'groupbussiness',
        redirect: '/group/bussiness/approval',
        component: ThreeLayout,
      ...
      },
      {
        ...
        name: 'groupperssion',
        component: ThreeLayout,
        redirect: '/group/permession/role',
  ...
  },
  {
    ...
    name: 'circlemanage',
    redirect: '/circlemanage/manage/info',
    ...
    children: [
      ...
      },
      {
        ...
        name: 'circlebusiness',
        component: ThreeLayout,
        redirect: '/circlemanage/business/noticeBatch',
      ...
      },
      {
        ...
        component: ThreeLayout,
        redirect: '/circlemanage/permession/role',
      ...
      },
      {
        ...
        name: 'groupbird',
        component: ThreeLayout,
        redirect: '/circlemanage/bird/recommend',
  ...
  },
  {
    path: '/circleandgroup',
    component: Layout,
    redirect: '/circleandgroup/team/folder',
    name: 'circleandgroup',
    ...
    children: [
      ...
      },
      {
        ...
        redirect: '/circleandgroup/programa/index',
      ...
      },
      {
        ...
        redirect: '/circleandgroup/classify/index',
  ...
  },
  {
    ...
    component: Layout,
    name: 'labelManage',
    redirect: '/label/shopLabelManage/listSearch',
    ...
    children: [
      ...
      },
      {
        ...
        name: 'people',
        component: ThreeLayout,
        redirect: '/label/peopleManage/peopleLabelSearch',
      ...
      },
      {
        ...
        redirect: '/label/behaviorStatisticsManage/behaviorManage',
        component: ThreeLayout,
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              {
                path: 'behaviorUserDetail',
                name: 'behaviorUserDetail',
                component: _import('label/behaviorUserDetail'),
      ...
      },
      {
        path: 'labelFactory',
        name: 'labelFactory',
        redirect: '/label/labelFactory/stageCreatLabel',
        component: ThreeLayout,
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'complainwomao',
        component: ThreeLayout,
        meta: { title: '我茂投诉管理', icon: 'muban' },
        children: [
          {
            path: 'untreatwomao',
            name: 'untreatwomao',
            component: _import('complainWomao/untreatwomao'),
            meta: { title: '未处理', icon: 'weichuli' }
          },
          {
            path: 'treatedwomao',
            name: 'treatedwomao',
            component: _import('complainWomao/treatedwomao'),
            meta: { title: '已处理', icon: 'yichuli' }
          }
        ]
      }
  ...
  }, // 下边是消息管理 // 许愿灯管理
  {
    ...
    component: Layout,
    // redirect: '/noticeManageOneWrapper/notice/index',
    ...
    children: [
      ...
      },
      {
        ...
        component: ThreeLayout,
        // redirect: '/noticeManageOneWrapper/myMaonoticeManage/index',
  ...
  },
  {
    path: '/accuratePush',
    component: Layout,
    redirect: '/accuratePush/lookTotalPic',
    name: 'accuratePush',
    ...
    children: [
      ...
      },
      {
        path: 'commParam',
        name: 'commParam',
        hidden: true, // 这是暂时没有用的模块   里面的接口都注掉了 2018.6.15晚1855  xiu
      ...
      {
        path: 'systemSocialMatch',
        name: 'systemSocialMatch',
        component: _import('accuratePush/systemSocialMatch'),
        meta: { title: '社交许愿灯-系统匹配', icon: 'tubiao' }
      }
    ]
  },
